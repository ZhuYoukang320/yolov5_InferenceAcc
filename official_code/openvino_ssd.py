...
def build_argparser():
    ...
    args.add_argument("-m", "--model", default='openvino_file/my_yolov5s.xml',help="Required. Path to an .xml file with a trained model.",
                      required=False, type=str)
    args.add_argument("-i", "--input", default=['images/dog.jpg'],help="Required. Path to image file.",
